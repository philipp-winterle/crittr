        ...
        const server = staticServer
            .listen(8000, async () => {
                try {
                    ...
                    // Second Run for URL
                    const { critical: noCssCritical, rest: noCssRest } = await Critter(noCssOptions);
                    ...
                    // Third Run for URL
                    const { critical: screenshotCssCritical, rest: screenshotCssRest } = await Critter(screenshotOptions);
                    ...
                    // Fourth Run for URL
                    const { critical: screenshotWithFunctionCssCritical, rest: screenshotWithFunctionCssRest } =
